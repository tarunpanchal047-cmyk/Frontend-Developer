...
//& Types of Function : 
//!  1. Name function (Function Declaration) :
//^  function which is having some name is called named function.
...
//^  When we are storing of function as a value inside the variable it is as known as function with expression.
...
//^  After creating the function immediately, we are invoking the function, is known as IIFE. It helps us to prevent the
...
//^  Function which calls itself, is valid recursive function.
//  * 5 = 5 * 4 * 3 * 2 * 1 = 120
...
//!  11. Generative function : 
//^  It is the special type of function which can pause and resume is execution. 

//& Yeild : It is a keyword which is used to pause the execution of the generative function.
//& Next () : It is a method which is used to resume the execution of the generative function.
//&  It is return as object which contains two property.
...
//! Default parameter :
//^  Default values which is initialized to the function parameter. so in case of absence of arguments these default value will be used.
...
//! Rest parameter :
//^   Rest parameter (...) is a javascript feature that collects multiple function arguments into a single array.

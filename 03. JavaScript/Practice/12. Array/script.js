...
//! slice :
//^  It accepts two arguments starting and ending index. And remove the elementspresent between starting and ending index. 
//^  it returns new array.It does not affect the original array.
...
//! splice :
//^  It accepts three arguments starting index, count (no of element wants to delete), new elements that we want to add. 
//^ It is used to remove, update, as well as add new element in the array. It return new array and it modifies the original array.
...
//! Reversed method :
//^  reverse the elements in an array in place. This method mutates the array and returns a reference 
...
//! Flat() :
//^  It converts multi-dimentional array into single dimentional array. 
...
//! some() :
//^  It accept callback function as an arrgument, and execute the function for each element present inside an array. 
//^  it returns true, if any one of the alement matches the condition. If none of the element matched the condition then it returns false.
...
//! every() :
//^  It accept callback function as an arrgument, and execute the function for each element present inside an array. it returns true,
//^  only when all the element passes the condition, if any one of element present inside the array fails to pass the condition then it returns false.
...
//! Push() : 
//^ It is used to add the elements from the end of the array. It modifies the original array. It returns the length of the updated array.
...
//! pop() :
//^  It is used to remove the element from the end of the array.it modifies the original array. It returns the removed element.
// let arr  = [10,20,30];
// console.log(arr);
// let res = arr.pop();
// console.log(res);
...
//! shift() :
//^  It is used to remove the element from the start of the array. It modifies the original array. It returns the removed element.
// let arr = [10,20,30,40]
// console.log(arr);
// let res = arr.shift();
// console.log(res);
...
//! unshift() :
//^  It is used to add the element from the start of the array,. It modifies the original array. It returns the lenght 0.
//  let arr = [10,20,30,40]
// console.log(arr);
...
// Find the maximum and minimum using one loop.
...
//! 🟣 JavaScript-Specific Coding Questions
...
// Handle API data using fetch().
// Create a search/filter functionality.
// Create pagination logic.
// Create a shopping-cart total calculation.

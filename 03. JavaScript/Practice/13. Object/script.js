//! Object :
//^   It is non premitive datatypes which is used to store the data in the form of key and value pairs.
...
// ! this keyword :
//^  It is a pointing mechanism, which points to the curret context of object.
...
//! Object.freeze() :
//^  Prevents the modification of existing property the addition of new properties, prevents the delection of existing properties.
...
//! Object.isFrozen() :
//^  returns boolean value, used to check wheater object is freezed or not.
// let obj ={
//     id : 1,
//     objName : "sandeep",
//     sal : 2000
...
// ! Object.isSealed() :
//^  Doesnot prevents, the modification of existing property, and prevents the addition of new properties, prevent the deletion 
...
//^  Copy of the values of all properties from one or more source object to a target object. Returns the target object.
...
//! Shallow copy :
//^  Copies the main container but shares the nested items. Changing a nested item in the copy will change the original.
...
//! Deep copy :
//^  Copies the container and duplicates all nested items. the copy is 100% independent. changing the copy never affects the original.
